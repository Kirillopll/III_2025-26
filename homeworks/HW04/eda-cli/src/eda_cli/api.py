...
# ---------- Дополнительный эндпоинт: все флаги качества из CSV ----------


@router.post(
    "/quality-flags-from-csv",
    tags=["quality"],
    summary="Вернуть полный набор флагов качества по CSV-файлу",
)
async def quality_flags_from_csv(file: UploadFile = File(...)) -> dict:
    """
    Принимает CSV-файл, запускает summarize_dataset + missing_table +
    compute_quality_flags и возвращает все флаги качества, включая новые
    эвристики из HW03.
    """
